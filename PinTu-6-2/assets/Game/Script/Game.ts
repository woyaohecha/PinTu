...
export class PuzzleScene extends cc.Component {
    ...
    private startGame(callback?) {
        ...
        let Title1 = GameConfig.currentLevelNum + 1;
        let Title2: string = GameConfig.levelData[GameConfig.currentLevelNum].level_name;
        ...
        let puzzle_cell = GameConfig.levelData[GameConfig.currentLevelNum].puzzle_cell;
    ...
    private overGame() {
        ...
        if (GameConfig.currentLevelNum >= GameConfig.levelData.length - 1) {
            isLast = true;
        }
        ...
        this.NextBtn.active = !isLast;
        this.FinishBtn.active = isLast;
    ...
    public judgeWin() {
        if (this.board.judgeWin()) {
            ...
            LevelListManager.setPassLevel(GameConfig.currentLevelNum);
            this.overGame();
        }
    }
